    ...
    <div class="box">
      ...
      <c:forEach var="info" items="${voidableDataTables}">
        <fieldset style="margin-top: 10px; border: 1px solid #ccc; padding: 10px;">
          <legend style="padding: 0 5px;"><b>${info.prettyName}</b> <span
              style="font-size: small; color: gray;">(${info.tableName})</span> (Count: <span
              style="color: red;">${info.voidedRecords}</span>)</legend>
