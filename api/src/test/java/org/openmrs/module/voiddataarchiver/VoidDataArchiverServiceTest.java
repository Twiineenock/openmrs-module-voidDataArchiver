...
import org.openmrs.module.voiddataarchiver.api.impl.VoidDataArchiverServiceImpl;
import static org.mockito.Mockito.*;
import static org.hamcrest.Matchers.*;
import static org.junit.Assert.*;

/**
 * This is a unit test, which verifies logic in VoidDataArchiverService. It doesn't extend
 * BaseModuleContextSensitiveTest, thus it is run without the in-memory DB and Spring context.
 */
public class VoidDataArchiverServiceTest {
	
	@InjectMocks
	VoidDataArchiverServiceImpl basicModuleService;
